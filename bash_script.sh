#!/bin/bash
#
#SBATCH --job-name=ALDH_RNAseq_12_13_21
#SBATCH --ntasks=10
#SBATCH --partition=bigmem
#SBATCH --nodelist=bigmem002
#SBATCH --time=240:00:00
#SBATCH --mem=100gb
#SBATCH --output=/data/ggc/flanagansteet_lab/smokash/ALDH_RNAseq/log_12_13_21/output_ALDH_RNAseq_12_13_21_%j.txt
#SBATCH --error=/data/ggc/flanagansteet_lab/smokash/ALDH_RNAseq/error_ALDH_RNAseq_12_13_21_%j.err
...
#
# 2. Its best to use TextWrangler (Mac) or Atom (Windows) to edit this code- you can see everything color coded
...
#    You dont need to mkdir the WORK_dir
#
# 4. Make sure to edit the location of the combined counts file at the end of the code.
#
# 5. After you login to secretariat go to your data/username folder and type
#    nano rnaseqcode_aldh.sh
#
# 6. In the nano part copy paste the entire text of this script Command+A Cmd+C Cmd=V;
#    then Exit by Ctrl+X
#
# 7. After exiting type sbatch rnaseqcode_aldh.sh and hit Enter. The script should start running.
...
export RAW_DIR="/data/ggc/flanagansteet_lab/smokash/Raw_data/ALDH_RNAseq"
export WORK_DIR="/data/ggc/flanagansteet_lab/smokash/ALDH_RNAseq/wk_dir_12_13_21"
#
...
do
	...
	outu=$f.nonrRNA.fq \
	k=31 \
	ref=/data/databases/rrna_silva/ribokmers.fa ;
done;
...
do
	...
	gsnap \
	--gunzip \
	-D /data/databases/h_sap/grch38/ensembl/indexed/gmap_gsnap  \
	-d ensembl_Homo_sapiens.GRCh38.dna.primary_assembly\
	$f \
	$R2 \
	-t 40 \cd D
	-N 1 \
...
do
	# featureCounts
	featureCounts \
	-a /data/databases/h_sap/grch38/ensembl/Homo_sapiens.GRCh38.99.gtf \
	-t exon \
	-F GTF \
	-g gene_id \
	-T 40 \
...
then
	...
	[ -s /data/ggc/flanagansteet_lab/smokash/ALDH_RNAseq/wk_dir_12_13_21/3_featurecounts/combined_counts.txt ]
